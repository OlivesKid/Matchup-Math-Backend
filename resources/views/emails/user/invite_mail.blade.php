                     ...
                     <td>
                        ...
                        <div style="background: #fff; color: #5b5b5b; border-radius: 4px; font-family: arial; font-size: 15px; padding: 10px 20px; width: 90%; margin: 20px auto; line-height: 17px; border: 1px #ddd solid; border-top: 0; clear: both;">
                           <p style="text-align: center;margin-top: 22px;">
                               New Challenege request from <b>{{$challenger_name}}</b>
                           </p>
                            <p style="text-align: center;margin-top: 22px;">
                              {{$msg}}
                           </p>
                           <p style="text-align: center;margin-top: 22px;">
                              <a href="{{$store}}" style="padding:7px;background-color: green;color:white;text-align: center;border-radius: 5px;text-decoration: none">Click to download App..</a>
                           </p>
                        </div>
