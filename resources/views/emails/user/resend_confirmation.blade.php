                        ...
                        <tr>
                            <td>
                                <div style="width: 96%; margin: auto; padding: 5px 0 0px 0;">
                                    <img style="text-align: center; margin: 20px 0 0 0;" src="{{\URL::to("assets/images/logo.png")}}" alt="{{config('constant.PLATFORM_NAME')}}" /></div>
                                    ...
                                    <div style="background: #fff; color: #5b5b5b; border-radius: 4px; font-family: arial; font-size: 15px; padding: 10px 20px; width: 90%; margin: 20px auto; line-height: 17px; border: 1px #ddd solid; border-top: 0; clear: both;">
                                        ...
                                        <p>
                                            A request to resend confirmation mail for your {{config('constant.PLATFORM_NAME')  }} account <span style="color:green">{{$email}}</span> was just made new activation link.<br>
                                        </p>
                                        <p style="text-align: center;margin-top: 22px;">
                                            <a href="{{URL::to('user/email-verify')}}/{{$activation_token}}" style="padding:7px;background-color: green;color:white;text-align: center;border-radius: 5px;text-decoration: none">Activate Account</a>
                                        </p>
                                    </div>
