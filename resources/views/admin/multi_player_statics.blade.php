...
@section('content')
    <script>
        var url = '{{URL::to("admin/multi-player-statics-filter")}}';
...
<!--                        <div class="col-md-2 md-form-group   m-t-md mrg-top m-l-sm m-r-sm">
            ...
            <div class="row">
                ...
                <div class="col-lg-3 colmd-3">
                    ...
                    <button type="button" class="btn md-raised btn-sm indigo waves-effect" onclick="changeRecordPerPage('{{URL::to("admin/multi-player-statics-filter")}}');" ><i class="mdi-av-replay editable i-16"></i>
                            </button>
                </div>
            </div>
            <br>
