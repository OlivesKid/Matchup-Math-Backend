...
<input type="hidden" id="current-sp" value="{{$data['crnt_page']}}"/>
<input type="hidden" id="total_page-sp" value="{{ $data['total_page'] }}"/>
<input type="hidden" id="len-sp" value="{{ $data['len'] }}"/>