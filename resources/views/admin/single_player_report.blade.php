...
@section('content')
    <script>
        var url = '{{URL::to("admin/single-player-report-filter")}}';
...
//            $('#cntrlbtn').css('display','none');
        ...
        $(document).ready(function(){
            ...
            $('#search_option').on('click',function(){
                ...
                var won_status = $('#won_status_search :selected').val();
                filters.user_id = user_id;
                filters.start_date = start_date;
                filters.end_date = end_date;
                filters.type = type;
                 filters.won_status = won_status;
        ...
        <div class="panel-body">
                  ...
                  <div id="collapse1" class="panel-collapse collapse ">
                    <div class="panel-body">
                       ...
                       <div class="col-md-2 md-form-group   m-t-md mrg-top m-l-sm m-r-sm">
                        ...
                        <div class="col-md-2 md-form-group   m-t-md mrg-top m-l-sm m-r-sm">
                            <select class="md-input" id="won_status_search" aria-invalid="false">
                                <option value="" selected="">All</option>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 colmd-3">
                    ...
                    <button type="button" class="btn md-raised btn-sm indigo waves-effect" onclick="changeRecordPerPage('{{URL::to("admin/single-player-report-filter")}}');" ><i class="mdi-av-replay editable i-16"></i>
                            </button>
                </div>
            </div>
            <br>
